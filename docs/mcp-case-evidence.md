...
All nine tests use controlled clocks, temporary journals, inert effect counters and
...
historical catalog manifest, owner-admission contract, four exact case IDs and their
required tests across both cores. The checker requires a complete passing 30-test
...
The report contains all 71 case IDs. Four carry current `PASS` evidence and 67 remain
...
compatibility, live registry or host isolation, any of the other 67 cases, or full
